...
public:
    ...
    float fb0lumakeyvalue=0.0;
    float fb0lumakeythresh=0.5;
    int fb0delayamnt=0;
    float fb0blend=0.0;
    ...
    float fb1lumakeyvalue=0.0;
    float fb1lumakeythresh=0.5;
    int fb1delayamnt=0;
    float fb1blend=0.0;
    ...
    ofxDatGuiButton* fb2_toroid_toggle;
    
    float fb2lumakeyvalue=0.1;
    float fb2lumakeythresh=.3;
    int fb2delayamnt=0;
    float fb2blend=.1;
    ...
    ofxDatGuiButton* fb3_toroid_toggle;
    
    float fb3lumakeyvalue=0.1;
    float fb3lumakeythresh=.3;
    int fb3delayamnt=0;
    float fb3blend=.1;
    ...
    bool ch1hue_inverttoggle=1;
    bool ch1sat_inverttoggle=1;
    bool ch1bright_inverttoggle=1;
    ...
    bool ch2hue_inverttoggle=1;
    bool ch2sat_inverttoggle=1;
    bool ch2bright_inverttoggle=1;
